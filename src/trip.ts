...
export const DAYS: readonly Day[] = [
  ...
  { id: 'd2', date: '2026-09-23', label: '23.9', dow: 'רביעי', note: 'אגם גארדה' },
  { id: 'd3', date: '2026-09-24', label: '24.9', dow: 'חמישי', note: 'אגם גארדה' },
  { id: 'd4', date: '2026-09-25', label: '25.9', dow: 'שישי', note: 'מעבר לדולומיטים' },
  { id: 'd5', date: '2026-09-26', label: '26.9', dow: 'שבת', note: 'דולומיטים' },
  { id: 'd6', date: '2026-09-27', label: '27.9', dow: 'ראשון', note: 'דולומיטים' },
  { id: 'd7', date: '2026-09-28', label: '28.9', dow: 'שני', note: 'דולומיטים' },
...
export const DEFAULT_AREAS: Record<AreaId, Area> = {
  garda: { he: 'אגם גארדה', color: '#2f7bbd' },
  dolomites: { he: 'דולומיטים', color: '#3f8f5e' },
  trentino: { he: 'טרנטינו / ואל די נון', color: '#3f8f8a' },
  verona: { he: 'ורונה וסביבה', color: '#8a5fb0' },
  milan: { he: 'מילאנו / מלפנסה', color: '#a4643a' },
  daytrip: { he: 'יעדים רחוקים', color: '#c1913a' },
};
...
// 48 places, imported from Google Takeout on 2026-09-04
  { id: 'p_orrido_di_ponte_alto', he: 'Orrido di Ponte Alto — קניון', orig: 'Orrido di Ponte Alto', type: 'hike', area: 'trentino', maps: 'https://www.google.com/maps/place/Orrido+di+Ponte+Alto/data=!4m2!3m1!1s0x478276c270d6399f:0xb1b53e372bfa9261' },
  { id: 'p_cooperativa_smeraldo_canyon_', he: 'קניון ריו סאס', orig: 'Cooperativa Smeraldo - Canyon Rio Sass', type: 'hike', area: 'trentino', notes: 'מסלול נליכה ו', maps: 'https://www.google.com/maps/place/Cooperativa+Smeraldo+-+Canyon+Rio+Sass/data=!4m2!3m1!1s0x478290271f6663e9:0x9d75b3bd9c3a8fc6' },
  ...
  { id: 'p_lago_di_tret', he: 'אגם טרט', orig: 'Lago di Tret', type: 'attraction', area: 'trentino', maps: 'https://www.google.com/maps/place/Lago+di+Tret/data=!4m2!3m1!1s0x47829100484b8801:0xde0b02921975adb3' },
  ...
  { id: 'p_parco_fluviale_novella', he: 'Parco Fluviale Novella', orig: 'Parco Fluviale Novella', type: 'attraction', area: 'trentino', notes: 'כל מיני סוגי אקסטרים', maps: 'https://www.google.com/maps/place/Parco+Fluviale+Novella/data=!4m2!3m1!1s0x478291c850b4f9c1:0x5f2df2e1eb64106d' },
  { id: 'p_cascata_di_tret', he: 'מפל טרט', orig: 'Cascata di Tret', type: 'hike', area: 'trentino', notes: 'מסלול הליכה קצר ומפל', maps: 'https://www.google.com/maps/place/Cascata+di+Tret/data=!4m2!3m1!1s0x47829026e1afe9bf:0x981a17d4b3771c4d' },
  { id: 'p_rafting_center_val_di_sole', he: 'רפטינג ואל די סולה', orig: 'Rafting Center Val di Sole', type: 'attraction', area: 'trentino', maps: 'https://www.google.com/maps/place/Rafting+Center+Val+di+Sole/data=!4m2!3m1!1s0x4782f596434a4d1b:0x78db3392d1047bd5' },
  ...
  { id: 'p_lake_como', he: 'אגם קומו', orig: 'אגם קומו', type: 'attraction', area: 'daytrip', maps: 'https://www.google.com/maps/place/%D7%90%D7%92%D7%9D+%D7%A7%D7%95%D7%9E%D7%95%E2%80%AD/data=!4m2!3m1!1s0x47843d32820b62f7:0x3e40c4eae898e1e0' },
  ...
  { id: 'p_venice', he: 'ונציה', orig: 'ונציה', type: 'attraction', area: 'daytrip', maps: 'https://www.google.com/maps/place/%D7%95%D7%A0%D7%A6%D7%99%D7%94%E2%80%AD/data=!4m2!3m1!1s0x477eb1daf1d63d89:0x7ba3c6f0bd92102f' },
  ...
  { id: 'p_artnatur_dolomites', he: 'Artnatur Dolomites — המלון שלנו', orig: 'Artnatur Dolomites', type: 'hotel', area: 'dolomites', maps: 'https://www.google.com/maps/place/Artnatur+Dolomites/data=!4m2!3m1!1s0x47780cc324b1387d:0x19b602b30d07c61a' },
  ...
  { id: 'p_belvedere_village', he: 'Belvedere Village', orig: 'Belvedere Village', type: 'attraction', area: 'verona', maps: 'https://www.google.com/maps/place/Belvedere+Village/data=!4m2!3m1!1s0x4781e9a78b10c287:0x9e1247b6b9706d22' },
